...
$\displaystyle\frac{-15}{19} = 1 + 2 \cdot \frac{-17}{19}$, ~~~~~~~~~~ $\Longrightarrow ~~~ \displaystyle\frac{17}{19} = (000011010111100101)^\infty 1$ \\
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=7cm]{Диаграмма 3.png}
...
Исходный код представлен в файле 2.py. Результаты его работы представлены на рисунках 3 --- 6.

\begin{figure}[!ht]
	\centering
	\includegraphics[width=15cm]{2_1.png}
	\caption{Проверка $f(x)$}
\end{figure}
\begin{figure}[!ht]
	\centering
	\includegraphics[width=15cm]{2_2.png}
	\caption{Проверка $g(x)$}
\end{figure}
\begin{figure}[!ht]
	\centering
	\includegraphics[width=12cm]{2_3.png}
	\caption{Разложение дробей в 2-адические числа}
\end{figure}
